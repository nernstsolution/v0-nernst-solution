...
export const products: Record<string, Product> = {
  "1kw-pem-test-stand": {
    ...
    name: "1 kW PEM Electrolyzer Test Stand",
    category: "test-stand",
  ...
  "600w-aem-test-stand": {
    ...
    specifications: {
      "Power Rating": "600 W",
      "Voltage Range": "0-25 V DC",
      "Current Range": "0-30 A",
      "Pressure Range": "1-20 bar",
      "Temperature Range": "20-70°C",
      "Flow Rate": "0-5 L/min",
      "Control Interface": "10-inch touchscreen",
      Communication: "Ethernet, USB, RS-485",
      Dimensions: "120 x 50 x 150 cm",
      Weight: "280 kg",
    },
    features: [
